/*
 * Manage la vue de consultation des stocks
 */
package yvs.stocks;
 ...
 */
@ManagedBean(name = "Mstock")
@SessionScoped
public class MouvementStocks extends ManagedUtil implements Serializable {

    private String refArt1, refArt2, depot, creno;
    private YvsBaseArticles art1, art2;
    private YvsBaseDepots depots;
