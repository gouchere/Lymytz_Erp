...
@ManagedBean
@SessionScoped
public class ComposantsEditable implements Serializable{

    public boolean fv_cat_compta = true, fv_model_reg = true, fv_adresse = true, fv_nom_client = true, fv_depot_liv = true, fv_date_liv = true, fv_tranche_liv = true, fv_depot_content = true, fv_conditionnement = true;

    public ComposantsEditable() {
    }
