...
public class AccesPage implements Serializable {
    ...
    public boolean param_agenc_, param_societ_, param_model_form, param_import_export, param_workflow;

    //Module Ressource Humaine grh_
    //Bloc Parametrage grh_bloc_param_
    public boolean grh_param_,
    ...
    public boolean grh_recrut_entretien,
            grh_recrut_doss_candidat;
    //Bloc Gestion administrative
    public boolean grh_format_, grh_mission_, grh_affect_, grh_sanct_, grh_assurance_;
    //Bloc Rémunération
    public boolean grh_bull_, grh_typ_dep_, grh_bloc_not_, grh_ges_retenu, grh_prelvm_ret_;
    //Bloc Gestion des présences
    public boolean grh_conge_, grh_presenc_, grh_chomag_;

    //Bloc Note de frais grh_bloc_not_
    public boolean grh_not_frai_;
    //Bloc Statistique 
    public boolean grh_tab_bord_, grh_rapports_paie, grh_param_stat;

    //Module Donnees de base base_
    public boolean base_user_, base_niv_, gen_view_parametre,
    ...
    public boolean gescom_paramG, gescom_paramC, gescom_personnel, gescom_pv, gescom_creno_p, gescom_commission, gescom_rist, gescom_cat_tarif, gescom_remise,
    ...
    public boolean compta_view_reg_vente, compta_cheq_reg_vente, compta_param_g,
            ...
            compta_view_op_div, compta_view_bon_prov,
    ...
    public boolean mutuel_param_g, mutuel_mutuelle, mutuel_mutualiste, mutuel_type_credit,
    ...
    //Module Production prod_
    public boolean ges_prod_param_g, ges_prod_nomenclature, ges_prod_poste_charge, ges_prod_gammes, ges_prod_unites, gen_view_publicites, ges_prod_commande,
    ...
    public boolean stat_general_com, stat_ca, stat_classement, stat_listing_vente, stat_journal_vente_vendeur, stat_ecart_vendeur, stat_classement_vendeur,
    ...
    //Module Projet proj_
    public boolean proj_departement, proj_projet;
    ...
    public boolean isCompta_view_bon_prov() {
        return compta_view_bon_prov;
    }

    public void setCompta_view_bon_prov(boolean compta_view_bon_prov) {
        this.compta_view_bon_prov = compta_view_bon_prov;
    }
    ...
    public boolean isGen_view_publicites() {
        return gen_view_publicites;
    }

    public void setGen_view_publicites(boolean gen_view_publicites) {
        this.gen_view_publicites = gen_view_publicites;
    }
