...
@ManagedBean
@SessionScoped
public class PlanReglementClient implements Serializable {
    ...
    private List<TrancheReglementClient> tranches;
    private boolean selectActif, new_;

    public PlanReglementClient() {
        tranches = new ArrayList<>();
    }

    public PlanReglementClient(long id) {
        this.id = id;
        tranches = new ArrayList<>();
    }

    public List<TrancheReglementClient> getTranches() {
        return tranches;
    }

    public void setTranches(List<TrancheReglementClient> tranches) {
    ...
    public boolean equals(Object obj) {
        ...
        final PlanReglementClient other = (PlanReglementClient) obj;
        if (this.id != other.id) {
            return false;
        }
        return true;
