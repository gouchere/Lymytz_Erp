...
@ManagedBean
@SessionScoped
public class CreditClient implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        final CreditClient other = (CreditClient) obj;
        if (this.id != other.id) {
            return false;
        }
        return true;
    ...
    public boolean canEditable() {
        for (YvsComptaReglementCreditClient c : reglements) {
