-- FUNCTION: public.grh_et_journal_salaire(bigint, character varying, character varying, character varying)

DROP FUNCTION IF EXISTS public.grh_et_journal_salaire(bigint, character varying, character varying, character varying);

CREATE OR REPLACE FUNCTION public.grh_et_journal_salaire(
	societe_ bigint,
...
ALTER FUNCTION public.grh_et_journal_salaire(bigint, character varying, character varying, character varying, boolean)
    OWNER TO postgres;
