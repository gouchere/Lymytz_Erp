-- FUNCTION: public.grh_et_recap_dipe_rav(bigint, character varying, character varying)

DROP FUNCTION IF EXISTS public.grh_et_recap_dipe_rav(bigint, character varying, character varying);

CREATE OR REPLACE FUNCTION public.grh_et_recap_dipe_rav(
	societe_ bigint,
...
ALTER FUNCTION public.grh_et_recap_dipe_rav(bigint, character varying, character varying, boolean)
    OWNER TO postgres;
