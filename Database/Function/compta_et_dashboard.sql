-- Function: compta_et_dashboard(bigint, bigint, character varying, character varying, date, date, character varying, character varying)

-- DROP FUNCTION compta_et_dashboard(bigint, bigint, character varying, character varying, date, date, character varying, character varying);

CREATE OR REPLACE FUNCTION compta_et_dashboard(IN agence_ bigint, IN societe_ bigint, IN comptedebut_ character varying, IN comptefin_ character varying, IN date_debut_ date, IN date_fin_ date, IN type_ character varying, IN periode_ character varying)
...
$BODY$
  ...
  COST 100
  ROWS 1000;
ALTER FUNCTION compta_et_dashboard(bigint, bigint, character varying, character varying, date, date, character varying, character varying)
  OWNER TO postgres;
