...
DECLARE
	...
	query_ character varying default 'select c.pua_recu, c.conditionnement from yvs_com_contenu_doc_achat c inner join yvs_com_doc_achats d on d.id = c.doc_achat where d.type_doc = ''FA'' AND d.statut = ''V'' AND c.article = '||article_;
