...
CREATE OR REPLACE FUNCTION get_pr(agence_ bigint, article_ bigint, depot_ bigint, tranche_ bigint, date_ date, unite_ bigint, current_ bigint)
...
END;$BODY$
  ...
  COST 100;
ALTER FUNCTION get_pr(bigint, bigint, bigint, bigint, date, bigint, bigint)
  OWNER TO postgres;
